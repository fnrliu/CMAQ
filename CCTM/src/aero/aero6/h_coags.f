...
C *** Arguments:
      ...
      TYPE(hyperdual) :: LAMDA   ! mean free path [ m ]
      ...
      TYPE(hyperdual) :: KNC     ! coefficient for Near Continuum regime
...
!     REAL( 8 ), PARAMETER :: A = 2.492D0
      ...
      TYPE(hyperdual) :: SQRTTWO  !  sqrt(2.0)
      TYPE(hyperdual) :: DLGSQT2  !  1/ln( sqrt( 2.0 ) )
...
c ***  Jiachen Liu addition 01/23/2021
